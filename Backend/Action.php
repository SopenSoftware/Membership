<?php
class Membership_Backend_Action extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_action';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_Action';
