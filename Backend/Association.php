<?php
class Membership_Backend_Association extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_association';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_Association';
