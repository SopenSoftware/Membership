<?php
class Membership_Backend_AwardList extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_award_list';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_AwardList';
