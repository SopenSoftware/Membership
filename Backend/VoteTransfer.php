<?php
class Membership_Backend_VoteTransfer extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_vote_transfer';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_VoteTransfer';
