<?php
class Membership_Backend_CommitteeFunction extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_committee_function';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_CommitteeFunction';
