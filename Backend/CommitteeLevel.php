<?php
class Membership_Backend_CommitteeLevel extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_committee_level';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_CommitteeLevel';
