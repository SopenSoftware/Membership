<?php
class Membership_Backend_FeeGroup extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_fee_group';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_FeeGroup';
