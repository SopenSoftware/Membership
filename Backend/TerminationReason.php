<?php
class Membership_Backend_TerminationReason extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_termination_reason';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_TerminationReason';
