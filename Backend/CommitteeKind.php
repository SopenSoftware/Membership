<?php
class Membership_Backend_CommitteeKind extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_committee_kind';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_CommitteeKind';
