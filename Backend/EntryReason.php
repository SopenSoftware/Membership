<?php
class Membership_Backend_EntryReason extends Tinebase_Backend_Sql_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_tableName = 'membership_entry_reason';
     ...
     * @var string
     */
    protected $_modelName = 'Membership_Model_EntryReason';
