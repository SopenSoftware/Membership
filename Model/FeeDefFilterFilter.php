<?php 
class Membership_Model_FeeDefFilterFilter extends Tinebase_Model_Filter_FilterGroup// implements Tinebase_Model_Filter_AclFilter
{
    /**
    ...
    protected $_className = 'Membership_Model_FeeDefFilterFilter';
