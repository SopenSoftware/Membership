 ...
 * @package     Membership
 */
class Membership_Model_Job extends Tinebase_Record_Abstract
{
	...
	const CATEGORY_FEEPROGRESS = 'FEEPROGRESS';
	const CATEGORY_FEEINVOICE = 'FEEINVOICE';
	const CATEGORY_FEEINVOICECURRENT = 'FEEINVOICECURRENT';
    ...
    public static function createRuntimeJob($accountId, $category, $name1 = null, $name2 = null, $data = null){
    	$job = new self();
    ...
    public static function createSchedulerJob($accountId, $category, $name1 = null, $name2 = null, $data = null){
    	$job = new self();
    	$job->__set('job_name1', $name1);
    	$job->__set('job_name2', $name2);
