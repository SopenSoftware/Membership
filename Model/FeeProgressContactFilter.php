...
class Membership_Model_FeeProgressContactFilter extends Tinebase_Model_Filter_ForeignId
{
    /**
    ...
    public function appendFilterSql($_select, $_backend)
    {
        ...
        $_select->where('member_id' . ' IN (?)', empty($this->_foreignIds) ? array('') : $this->_foreignIds);
    }
