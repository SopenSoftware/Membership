 ...
 */
Tine.Membership.AwardListGridPanel = Ext.extend(Tine.widgets.grid.GridPanel, {
    ...
    initComponent: function() {
        this.recordProxy = Tine.Membership.awardListBackend;
        ...
        Tine.Membership.AwardListGridPanel.superclass.initComponent.call(this);
    },
    initFilterToolbar: function() {
		//var quickFilter = [new Tine.widgets.grid.FilterToolbarQuickFilterPlugin()];	
		this.filterToolbar = new Tine.widgets.grid.FilterToolbar({
            app: this.app,
            filterModels: Tine.Membership.Model.AwardList.getFilterModel(),
            defaultFilter: 'query',
