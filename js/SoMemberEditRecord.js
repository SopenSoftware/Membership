...
Tine.Membership.getSoMemberEditPanel = function(fgpPanel, bankAccountWidget){
	return {
		xtype: 'panel',
		...
		items:[{
			...
			autoScroll: true,
			border:false,
		    items: Tine.Membership.getSoMemberFormItems(fgpPanel, bankAccountWidget)
		}]};
}

Tine.Membership.getSoMemberEditPanelEmbedded = function(fgpPanel, bankAccountWidget){
	return {
		xtype: 'panel',
		id: 'somember-edit-dialog-panel',
