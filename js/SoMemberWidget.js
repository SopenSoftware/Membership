Tine.Membership.SoMemberWidget = function(config) {
    Ext.apply(this, config);
    Tine.Membership.SoMemberWidget.superclass.constructor.call(this);
};

Ext.extend(Tine.Membership.SoMemberWidget, Ext.Panel, {
	editDialog: null,
	ddConfig:{
		ddGroupSoMember: 'ddGroupSoMember',
	...
	initComponent: function(){
		...
		Tine.Membership.SoMemberWidget.superclass.initComponent.call(this);
	},
    /**
    ...
    initDefaultTemplate: function() {
        this.defaultTpl = new Ext.XTemplate(
                ...
                '<div class="preview-panel preview-panel-timesheet-left">',
                    '<div class="preview-panel-declaration">SoMembers</div>',
        ...
        this.tpl = new Ext.XTemplate(
            '<tpl for=".">',
                 ...
                 '<div class="contact-widget-contact">',
                	'<span class="preview-panel-bold">{[this.encode(values.somember_contact_title, "mediumtext")]}</span><br/><strong>{[this.encode(values.membership_named_type, "mediumtext")]}</strong>',
                 '</div>',
             '</div>',
         '</div>',
         '</tpl>',
    ...
    onLoadSoMember: function(record){
    ...
    initDropZone: function(){
		...
		this.dd = new Ext.dd.DropTarget(this.el, {
			scope: this,
			ddGroup     : this.ddConfig.ddGroupSoMember,
		...
		this.dd.addToGroup(this.ddConfig.ddGroupGetSoMember);
	}
});

Ext.reg('somemberwidget',Tine.Membership.SoMemberWidget);