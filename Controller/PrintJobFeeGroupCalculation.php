 ...
 *
 */
class Membership_Controller_PrintJobFeeGroupCalculation extends Tinebase_Controller_Abstract{
	...
	public function printFeeGroupCalculation($processArray, $exportProcessor){
